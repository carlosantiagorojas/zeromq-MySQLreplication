...
public class ProcesoHomologoDos {
    public void iniciar(GC gestor) throws InterruptedException
    {
        // Inicio el gestor
        try (ZContext context = new ZContext()){

            System.out.println("------------------INICIANDO PROCESO HOMOLOGO SEDE 2----------------");
            ...
            if(e.getErrorCode() == 4){
                System.out.println("No se recibio respuesta del gestor 1, terminando ejecucion del gestor 2... \n");
            }
